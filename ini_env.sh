...
sudo sed -i '/\#sudo mount -t vboxsf -o uid=1000,gid=1000 Vboxshare \/home\/visanuwan\/VboxShare/c\sudo mount -t vboxsf -o uid=1000,gid=1000 Vboxshare \/home\/visanuwan\/VboxShare' $rc_local
